...
ifneq "$(CC_VERSION_TEXT)" "arm-oe-eabi-gcc (GCC) 13.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "/home/hedl/tb_work/am6254/yocto/bootloadr/uboot"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/opt/ti-processor-sdk-linux-am62xx-evm-10.00.07.04/k3r5-devkit/sysroots/x86_64-arago-linux/usr/bin/arm-oe-eabi/arm-oe-eabi-gcc"
include/config/auto.conf: FORCE
endif
